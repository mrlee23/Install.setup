...
#+HTML_HEAD: <link rel="alternate" href="http://linux-command.org/ko/SELinux" hreflang="ko" />
#+HTML_HEAD: <link rel="alternate" href="http://linux-command.org/en/SELinux" hreflang="en" />
#+HTML_HEAD: <link rel="alternate" href="http://linux-command.org/ja/SELinux" hreflang="ja" />
#+HTML_HEAD: <link rel="alternate" href="http://linux-command.org/es/SELinux" hreflang="es" />
#+HTML_HEAD: <link rel="alternate" href="http://linux-command.org/zh/SELinux" hreflang="zh" />
